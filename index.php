...
<head>
    <title>Cardápio Digital - Pastel das Coleguinhas - Alphaville - Home</title>
    <link rel="manifest"
    ...
    <script type="text/javascript"
        src="https://bam-cell.nr-data.net/1/4ce70e41b9?a=1649986571&amp;sa=1&amp;v=1212.e95d35c&amp;t=Unnamed%20Transaction&amp;rst=846&amp;ck=1&amp;ref=https://www.cardapiodigital.io/4db34d3e-028c-4788-bbec-0c368d227bb0&amp;be=431&amp;fe=833&amp;dc=697&amp;af=err,xhr,stn,ins,spa&amp;perf=%7B%22timing%22:%7B%22of%22:1650989258540,%22n%22:0,%22u%22:419,%22ue%22:419,%22f%22:8,%22dn%22:8,%22dne%22:8,%22c%22:8,%22ce%22:8,%22rq%22:8,%22rp%22:406,%22rpe%22:407,%22dl%22:422,%22di%22:440,%22ds%22:697,%22de%22:697,%22dc%22:833,%22l%22:833,%22le%22:835%7D,%22navigation%22:%7B%22ty%22:1%7D%7D&amp;fp=450&amp;fcp=450&amp;jsonp=NREUM.setToken">
    </script>
        ...
        window.NREUM || (NREUM = {}), __nr_require = function(t, e, n) {
            ...
            4: [function(t, e, n) {
                ...
                if (w[v] && y.xhrWrappable && !y.disabled) {
                    ...
                    var L, U = 0;
                    M.on(u, r), b.on(p, r), S.on(p, r), M.on(d, o), b.on(l, o), S.on(l, o), M.buffer([u,
                            d, "xhr-resolved"
                        ]), R.buffer([u]), O.buffer(["setTimeout" + c, "clearTimeout" + s, u]), P
            ...
            17: [function(t, e, n) {
                function r(t) {
                    ...
                    if (!this.ended) {
                        ...
                        e.aborted || (n.duration = a.now() - this.startTime, this.loadCaptureCalled ||
                            4 !== t.readyState ? null == e.status && (e.status = 0) : i(this, t), n
                            .cbTime = this.cbTime, s("xhr", [e, n, this.startTime, this.endTime,
                                "xhr"
                            ], this))
                    }
                }
                ...
                if (a.xhrWrappable && !a.disabled) {
                    ...
                    a.features.xhr = !0, t(15), t(8), u.on("new-xhr", function(t) {
                        ...
                        e instanceof y && "load" === t[0] && u.emit("xhr-load-added", [t[1], t[
                            2]], e)
                    }), u.on("removeEventListener-end", function(t, e) {
                        e instanceof y && "load" === t[0] && u.emit("xhr-load-removed", [t[1],
                            t[2]
                        ], e)
                        ...
                        var n, r = this.opts || {},
                            i = this.target;
                        "string" == typeof i ? n = i : "object" == typeof i && i instanceof g ?
                            n = i.url : window.URL && "object" == typeof i &&
                            i instanceof URL && (n = i.href), o(this, n);
                ...
                function a(t) {
                    if (t instanceof v && !g) {
                        ...
                        e <= l.now() ? n.fid = l.now() - e : e > l.offset && e <= Date.now() ? (e -= l
                            .offset, n.fid = l.now() - e) : e = l.now(), g = !0, p("timing", ["fi",
                            e, n
                        ])
                    }
                }
            ...
            loader: [function(t, e, n) {
                ...
                if (!b) {
                    t(20), t(28), v[w] ? (v[w]("DOMContentLoaded", i, l(!1)), m[w]("load", r, l(!1))) :
                        (v[g]("onreadystatechange", o), m[g]("onload", r)), s("mark", ["firstbyte", a
                            .getLastTimestamp()
                        ], null, "api");
                    var P = 0
                }
...
<body style="overflow: unset;">
    <div id="__next" data-reactroot="">
        <main>
            <div class="sc-bczRLJ styles__Wrapper-sc-1huehxr-0 jWxBrO iEyCrt">
                <div class="styles__Hero-sc-1huehxr-1 jwxOWq">
                    <div class="styles__TextContainer-sc-1huehxr-2 fXXSGu">
                        <h1 color="white" class="sc-gKXOVf dBmwPg styles__HomeHeading-sc-1huehxr-4 bKmxr">Olá!</h1><span
                            color="white" class="sc-fLlhyt jgYJA Text-sc-1c4vg4w-0 daygwi">Faça seu pedido de forma
                            rápida e prática aqui na nossa loja.</span>
                    </div>
                </div>
                <div class="sc-bczRLJ styles__Body-sc-1huehxr-3 fKVRiu djjIaF">
                    <div class="styles__LogoContainer-sc-ybdxuq-0 nxLAP"><span
                            style="box-sizing:border-box;display:inline-block;overflow:hidden;width:110px;height:105px;background:none;opacity:1;border:0;margin:0;padding:0;position:relative"><img
                                alt="Pastel das Coleguinhas - Alphaville"
                                src="https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg"
                                decoding="async" data-nimg="fixed"
                                style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                srcset="https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg 1x, https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg 2x"><noscript><img
                                    alt="Pastel das Coleguinhas - Alphaville"
                                    srcSet="https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg 1x, https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg 2x"
                                    src="https://static-images.ifood.com.br/image/upload/t_medium/logosgde/4db34d3e-028c-4788-bbec-0c368d227bb0/202203082204_eIwD_i.jpg"
                                    decoding="async" data-nimg="fixed"
                                    style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                    loading="lazy" /></noscript></span></div>
                    <h1 font-weight="500" class="sc-gKXOVf cQzSft">Pastel das Coleguinhas - Alphaville</h1>
                    <div class="sc-bczRLJ fKVRiu">
                        <div tabindex="0" aria-label="Estamos Fechado"
                            class="sc-bczRLJ styles__StatusTag-sc-ybdxuq-1 fKVRiu hWJpaB">Fechado</div><span
                            color="grayDarkest" font-weight="300" tabindex="0"
                            class="sc-fLlhyt dzVOqm Text-sc-1c4vg4w-0 daygwi">Abriremos às 18:00</span>
                    </div>
                    <hr class="sc-jIZahH styles__StatusDivider-sc-ybdxuq-2 eDeWDG emaoZp"><button
                        class="sc-bczRLJ styles__Container-sc-1jngg5y-0 inRktw FLMJe"><span color="black"
                            class="sc-bjUoiL intXeD Text-sc-1c4vg4w-0 styles__LinkText-sc-ybdxuq-6 daygwi favAmI">Compartilhar
                            cardápio</span></button><button
                        class="ButtonClean-sc-i0rf7s-0 styles__AddressAndShifts-sc-ybdxuq-3 eFMOem fNFgvR"><span
                            color="black"
                            class="sc-fLlhyt ebmjrL Text-sc-1c4vg4w-0 styles__LinkText-sc-ybdxuq-6 daygwi favAmI">Endereço
                            e horários</span></button>
                    <div class="sc-bczRLJ styles__ButtonContainer-sc-ybdxuq-4 fKVRiu kVjuDL"><button
                            class="sc-hAZoDl fPwles styles__Button-sc-ybdxuq-5 kqQHpK">Ver cardápio</button></div>
                    <button class="ButtonClean-sc-i0rf7s-0 eFMOem"><span color="black"
                            class="sc-fLlhyt BMMry Text-sc-1c4vg4w-0 styles__LinkText-sc-ybdxuq-6 daygwi favAmI">Por que
                            aparece iFood no link do Cardápio?</span></button>
                </div>
            </div>
        </main>
    ...
    <div></div><iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame"
